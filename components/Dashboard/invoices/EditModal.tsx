...
export function EditModal({
  ...
  const defaultValues: InvoiceFormData = {
    ...
    currency: invoice.currency as "NGN" | "USD" | "GBP" | "EUR",
    ...
    async (data: InvoiceFormData) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          window.alert(result.error || "Failed to update invoice");
        }
      } catch (error) {
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 xs:gap-4">
                    <div className="bg-yellow-100 p-2 sm:p-3 rounded-lg">
                      <Receipt className="size-5 xs:size-6 text-yellow-600" />
                    </div>
                    <div>
